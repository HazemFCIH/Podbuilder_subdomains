<head>
    <title>Podbuilder &mdash; Home</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('assets/frontend/https://cdn.jsdelivr.net/npm/mediaelement@4.2.7/build/mediaelementplayer.min.css')}}">
