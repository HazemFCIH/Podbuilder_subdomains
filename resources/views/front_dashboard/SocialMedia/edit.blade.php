...
@section('mid_section')
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <h6 class="text-right text-sm-start">
                <a href="{{URL::to('/')}}/podcasts/{{$social_medium->podcast->sub_domain}}" class="text-capitalize">view site
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="user" method="post" action="{{route('dashboard.social-media.update',$social_medium->id)}}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="facebook.com/podcast" name="facebook_link" value="{{$social_medium->facebook_link}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="instagram.com/podcast" name="instagram_link" value="{{$social_medium->instagram_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Instagram link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="twitter.com/podcast" name="twitter_link" value="{{$social_medium->twitter_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Twitter link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="linkedin.com/podcast" name="linkedIn_link" value="{{$social_medium->linkedIn_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        LinkedIn link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="itunes.com/podcast" name="apple_link" value="{{$social_medium->apple_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Apple Podcast link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="google.com/podcast" name="google_link" value="{{$social_medium->google_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Google Podcast link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="deezer.com/podcast" name="deezer_link" value="{{$social_medium->deezer_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Deezer link
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user rounded-0 "
                           id="examplePostName" placeholder="anghami.com/podcast" name="anghami_link" value="{{$social_medium->anghami_link}}">
                    <div id="examplePostName" class="form-text text text-xs">
                        Anghami link
                    </div>
                </div>
                ...
                <input type="hidden" name="podcast_id" value="{{$social_medium->podcast->id}}">
